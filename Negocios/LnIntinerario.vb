...
Public Class LnIntinerario
    ...
    Public Function BorrarIntinerario(itinerarioId As Integer) As Boolean
        Try
            ...
            If objDatos.spBorrarItinerario(itinerarioId) Then
                Return True
            Else
                Return False
            End If
    ...
    Public Function ConsultarItinerarioPorFiltro(paisDesdeId As Integer, paisHastaId As Integer, cuandoViaja As Date, cuandoRegresa As Date, aeropuertoOrigenId As Integer, aeropuertoDestinoId As Integer)
        Dim ds As New DataSet
        Try

            Try
                ds = objDatos.ConsultarItinerarioPorFiltro(paisDesdeId, paisHastaId, cuandoViaja, cuandoRegresa, aeropuertoOrigenId, aeropuertoDestinoId)
